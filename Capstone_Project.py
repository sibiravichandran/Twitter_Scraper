...
selected1 = streamlit_option.option_menu(
    menu_title = "Scraping Twitter Data",  
...
if selected1 == "About":
    ...
    st.header("**:blue[_Welcome to the Twitter Scraping Capstone Page_]** :speech_balloon:")


    st.subheader('Twitter Scraping web app is created using Streamlit.')
    st.subheader("It scrapes the twitter data for the given hashtag/ keyword for the specified time period and also scrapes the data according to the number of counts the user requires.")
    st.subheader("The tweets can then be uploaded in the MongoDB database and can be downloaded as CSV or a JSON file.")
